    ...
    return CosmicDialogPanel(
      ...
      children: [
        ...
        _SectionCard(
          ...
          child: Column(
            children: [
              ...
              const _SectionDivider(),
              _SwitchRow(
                title: _lang.t('settings_show_own_size'),
                subtitle: _lang.t('settings_show_own_size_desc'),
                value: _settings.showOwnSize,
                onChanged: _settings.setShowOwnSize,
              ),
              const _SectionDivider(),
              _SwitchRow(
                title: _lang.t('settings_show_other_sizes'),
                subtitle: _lang.t('settings_show_other_sizes_desc'),
        ...
        _SectionCard(
          ...
          title: _lang.t('settings_performance_section'),
          child: _SwitchRow(
            title: _lang.t('settings_low_performance'),
            subtitle: _lang.t('settings_low_performance_desc'),
            value: _settings.lowPerformanceMode,
            onChanged: _settings.setLowPerformanceMode,
          ),
        ),
        const SizedBox(height: 12),
        _SectionCard(
